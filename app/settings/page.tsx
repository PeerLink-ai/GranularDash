...
const defaultAvatars = [
  "/professional-business-woman-headshot.png",
  "/professional-businessman-headshot.png",
  "/professional-executive-woman.png",
  "/placeholder-v0biv.png",
  "/professional-consultant-woman.png",
  "/professional-consultant-man.png",
  "/professional-manager-woman.png",
  "/professional-manager-man.png",
  "/professional-woman-director.png",
  "/professional-director-man.png",
]
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="full-name"
                  value={user?.name || settings.fullName}
