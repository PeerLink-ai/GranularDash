...
const navigation = [
  { name: "AI Governance Dashboard", href: "/", icon: Home },
  ...
  { name: "Users & Roles", href: "/users-roles", icon: Users2 },
  { name: "Access Control", href: "/access-control", icon: Key },
  { name: "Incident Response", href: "/incident-response", icon: MessageSquare },
  { name: "Training & Simulation", href: "/training-simulation", icon: Video },
]
            ...
            <div className={cn("flex h-16 items-center gap-2 px-4", isCollapsed && "justify-center px-2")}>
              {!isCollapsed && (
                <Link href="/" className="flex items-center font-semibold">
                  <span className="text-lg">Granular</span>
                </Link>
              )}
              <Button
                variant="ghost"
