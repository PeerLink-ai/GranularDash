...
CREATE INDEX idx_policy_violations_organization ON policy_violations(organization_id);
...
CREATE INDEX idx_connected_agents_organization ON connected_agents(organization_id);
